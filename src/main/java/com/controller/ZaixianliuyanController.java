...
public class ZaixianliuyanController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZaixianliuyanEntity zaixianliuyan,
		...
		if(tableName.equals("xuesheng")) {
			zaixianliuyan.setXueshengxuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jianzhirenyuan")) {
			zaixianliuyan.setZhanghao((String)request.getSession().getAttribute("username"));
		}
